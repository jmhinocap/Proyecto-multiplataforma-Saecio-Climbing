...
public class LeerUsuarioPorNombreOCorreoCommand {
    
    @Autowired
    private UsuarioService usuarioService;
    
    private final String usuarioOCorreo;
    
    private boolean canExecute() {
        return Objects.nonNull(usuarioOCorreo);
    }
    
    private UsuarioResource doExecute() {
        log.info("[LeerUsuarioPorNombreOCorreoCommand]-[usuarioOCorreo: {}]-[Start]", usuarioOCorreo);
        return usuarioService.leerUsuarioPorNombreOCorreo(usuarioOCorreo);
    }
